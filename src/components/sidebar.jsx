          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            <div className="text-center">
              ...
              <span className="email">
                <i className="icon-mail"></i> hungnm.nuce60@gmail.com
              </span>
            </div>
            ...
            <nav id="colorlib-main-menu">
              <ul>
                <li>
                  <a
                    href="https://www.facebook.com/hungghihi"
                    target="_blank"
                ...
                <li>
                  <a
                    href="https://twitter.com/hungghihi"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                ...
                <li>
                  <a
                    href="https://www.instagram.com/hungghihi/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                ...
                <li>
                  <a
                    href="https://github.com/manhhungpm"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
